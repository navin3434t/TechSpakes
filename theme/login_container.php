...
<title> <?php echo $pageTitle;?> | <?php $systemConfiguration[0]->website_title;?> </title>
...
<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/wow/wow.js"></script>
<script type="text/javascript">
    /* WOW animations */
...
<img src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/image-resources/blurred-bg/blurred-bg-3.jpg" class="login-img wow fadeIn" alt="">
                    ...
                    <div class="content-box-wrapper">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="exampleInputEmail1" placecholder="Enter Email/Username">
                                <span class="input-group-addon bg-blue">
                                    <i class="glyph-icon icon-envelope-o"></i>
                                </span>
								
                            </div>
							<br><span id="exampleInputEmail1_Err"></span>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <input type="password" class="form-control" id="exampleInputPassword1" placecholder="Password">
                                <span class="input-group-addon bg-blue">
                                    <i class="glyph-icon icon-unlock-alt"></i>
                                </span>
								
                            </div>
							<br><span id="exampleInputPassword1_Err"></span>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/bootstrap/js/bootstrap.js"></script>

<!-- Bootstrap Dropdown -->

<!-- <script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/dropdown/dropdown.js"></script> -->

<!-- Bootstrap Tooltip -->

<!-- <script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/tooltip/tooltip.js"></script> -->

<!-- Bootstrap Popover -->

<!-- <script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/popover/popover.js"></script> -->

<!-- Bootstrap Progress Bar -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/progressbar/progressbar.js"></script>

<!-- Bootstrap Buttons -->

<!-- <script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/button/button.js"></script> -->

<!-- Bootstrap Collapse -->

<!-- <script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/collapse/collapse.js"></script> -->

<!-- Superclick -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/superclick/superclick.js"></script>

<!-- Input switch alternate -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/input-switch/inputswitch-alt.js"></script>

<!-- Slim scroll -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/slimscroll/slimscroll.js"></script>

<!-- Slidebars -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/slidebars/slidebars.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/slidebars/slidebars-demo.js"></script>
...
<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/screenfull/screenfull.js"></script>

<!-- Content box -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/content-box/contentbox.js"></script>

<!-- Overlay -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/overlay/overlay.js"></script>

<!-- Widgets init for demo -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/js-init/widgets-init.js"></script>

<!-- Theme layout -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/themes/admin/layout.js"></script>

<!-- Theme switcher -->

<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/widgets/theme-switcher/themeswitcher.js"></script>


<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/customjs/techCommon.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/customjs/techLogin.js"></script>
</body>
