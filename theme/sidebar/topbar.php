    ...
    <div id="header-nav-left">
        <div class="user-account-btn dropdown">
            <a href="#" title="My Account" class="user-profile clearfix" data-toggle="dropdown">
				<?php if(isset($loginUserData[0]->userPicture) && !empty($loginUserData[0]->userPicture)){?>
					<img width="28" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/image-resources/gravatar.jpg" alt="Profile image">
				<?php } else { ?>
					<img width="28" src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/image-resources/gravatar.jpg" alt="Profile image">
				<?php } ?>
                <span><?php echo $loginUserData[0]->userFirstName;?></span>
                ...
                <div class="box-sm">
                    <div class="login-box clearfix">
                        <div class="user-img">
                            ...
                            <img src="<?php echo $this->config->item('techspake_site_base_url');?>/assets/image-resources/gravatar.jpg" alt="">
                        </div>
                        <div class="user-info">
                            <span>
                                <?php 
								
								echo $loginUserData[0]->userFirstName;?>
                                <i><?php echo $loginUserData[0]->userDesignation;?></i>
                            </span>
        ...
        <div class="hide" id="popover-search">
            <div class="pad5A box-md">
                <div class="input-group">
                    <input type="text" class="form-control" placecholder="Search terms here ...">
